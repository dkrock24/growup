                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Thanks for create a new user in our GrowUp platform.
                                        </p>
                                        ...
                                        <div class="col-lg-12 mb-12 mb-xl-0">
                                            <small class="text-light fw-medium">Customer Details</small>
                                            <div class="demo-inline-spacing mt-3">
                                                <div class="list-group list-group-flush">
                                                    <label class="list-group-item list-group-item-action">First Name :
                                                        {{ $content['first_name'] }} </label>
                                                    <label class="list-group-item list-group-item-action">Last Name : {{
                                                        $content['last_name']}}</label>
                                                    <label class="list-group-item list-group-item-action">Email : {{
                                                        $content['email']}}</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Please reach out us if there is any issue about your customer information
                                            already created. Contact us. 213-2492-760
                                        </p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Regards,<br>
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        Use the following link if you want to login in GrowUp platform:
