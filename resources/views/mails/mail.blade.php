                                    ...
                                    <tr>
                                        <td class="content-cell"
                                            ...
                                            <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                You are receiving this email because a new job was created please check the job details below.
                                            </p>
                                            ...
                                            <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                <div class="col-lg-12 mb-12 mb-xl-0">
                                                    <small class="text-light fw-medium">Job Details</small>
                                                    <div class="demo-inline-spacing mt-3">
                                                      <div class="list-group list-group-flush">
                                                        ...
                                                        <label class="list-group-item list-group-item-action">Job Total : $ {{ $content['total']}}</label>
                                                      </div>
                                                    </div>
                                                  </div>
                                            </p>
                                            <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                Please reach out us if there is any issue about your Job already scheduled. Contact us. 213-2492-760 
                                            </p>
                                            <p
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        <p
                                                            ...
                                                            Use the following link if you want to login in GrowUp platform: <span
                                                                class="break-all"
