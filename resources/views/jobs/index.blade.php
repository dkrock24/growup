          ...
          <nav aria-label="Page navigation">
            <ul class="pagination">
              <li class="page-item first">
                <a class="page-link" href="/jobs?page=1"><i class="tf-icon bx bx-chevrons-left"></i></a>
              </li>
              <li class="page-item prev">
                <a class="page-link" href="/jobs?page={{$jobs->currentPage()-1}}"><i class="tf-icon bx bx-chevron-left"></i></a>
              </li>

              <li class="page-item active">
                <a class="page-link" href="/jobs?page={{$i}}">{{ $jobs->currentPage() }}</a>
              </li>
              <li class="page-item prev">
                <a class="page-link" href="/jobs?page={{$jobs->currentPage()+1}}"><i class="tf-icon bx bx-chevron-right"></i></a>
              </li>
              ...
              <li class="page-item last">
                <a class="page-link" href="/jobs?page={{ $jobs->lastPage()}}"><i class="tf-icon bx bx-chevrons-right"></i></a>
              </li>
              <li class="page-item last">
                <a class="page-link" href=""><i class="tf-icon bx bx-list"> {{ $i - 1 }} / {{ $jobs->total() }}</i></a>
              </li>
            </ul>
