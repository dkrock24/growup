...
<head>
    ...
    <title>Sign Up - GrowUp</title>

    <!-- Font Icon -->

    <!-- Main css -->
    @vite(['resources/css/style.css', 'resources/fonts/material-icon/css/material-design-iconic-font.min.css'])
</head>
<body>
                ...
                <div class="signup-content">
                    <form method="POST" action="{{ route('createUser') }}">
                        ...
                        <div class="row mb-3 form-group">
                            ...
                            <div class="col-md-6">
                                <input id="last_name" type="text" class="form-input @error('name') is-invalid @enderror" name="last_name" value="{{ old('last_name') }}" required autocomplete="last_name" autofocus>
                        ...
                        <div class="form-group">
                            <input type="checkbox" name="agreed" id="agree-term" class="agree-term" />
    ...
    @vite(['resources/js/main.js', 'resources/vendor/jquery/jquery.min.js'])
